  ...
  legs: [
...

    {
      ...
      activities: [
        ...
        { name: "Lou Malnati's · River North", image: "https://ak-d.tripcdn.com/images/100i0i0000009hxn57852_D_750_520_Q90.jpg?proc=autoorient", meal: "quick", price: "$$", type: "Deep-dish pizza", typeIcon: "🍕", note: "Una delle scelte classiche per la deep-dish. Considerate i tempi di cottura: non è proprio una pizza 'al volo'.", mapsQuery: "Lou Malnati's 439 N Wells St Chicago" },
...
{ time:"Da definire", kind:"booked", icon:"✈️", title:"Volo LAS → ORD", note:"Orario lasciato vuoto finché l'agenzia non conferma il nuovo volo." },
  ...
  chicago: [
    ...
    { date:"2026-10-31", title:"Halloween a Chicago 🎃", theme:"Turismo leggero di giorno, Haunted Halsted come evento principale", special:true, items:[
      ...
      { time:"10:45", kind:"recommended", icon:"🌉", title:"Chicago Riverwalk", note:"Scendete verso il fiume e passeggiate tra ponti e grattacieli senza fretta.", mapsQuery:"Chicago Riverwalk", mapLat:41.8877, mapLon:-87.6263, detailPlace:"Chicago Riverwalk" },
      { time:"12:30", kind:"recommended", icon:"🌭", title:"Portillo's · River North", note:"Pranzo rapido con Chicago-style hot dog o Italian beef.", mapsQuery:"Portillo's 100 W Ontario St Chicago", mapLat:41.8930, mapLon:-87.6312, detailRestaurant:"Portillo's · River North" },
      { time:"14:00", kind:"recommended", icon:"🌳", title:"Millennium Park", note:"Pritzker Pavilion, Crown Fountain e una passeggiata nel parco.", mapsQuery:"Millennium Park Chicago", mapLat:41.8826, mapLon:-87.6226, detailPlace:"Millennium Park" },
      { time:"14:40", kind:"recommended", icon:"☁️", title:"Cloud Gate · The Bean", note:"Tappa dedicata al simbolo del parco e alle classiche foto con lo skyline riflesso.", mapsQuery:"Cloud Gate Chicago", mapLat:41.8827, mapLon:-87.6233, detailPlace:"Cloud Gate · The Bean" },
      { time:"16:15", kind:"recommended", icon:"🏨", title:"Rientro al Warwick Allerton", note:"Riposo e cambio prima di Halloween." },
      { time:"16:50", kind:"recommended", icon:"🚇", title:"Partenza per Northalsted", note:"CTA o rideshare verso Halsted & Belmont; meglio arrivare prima che la zona si riempia.", mapsQuery:"Drew's on Halsted Chicago" },
      { time:"17:30", kind:"recommended", icon:"🍔", title:"Drew's on Halsted", note:"Cena direttamente all'inizio della zona della parata. Finito di mangiare siete già a Halsted & Belmont.", mapsQuery:"Drew's on Halsted 3201 N Halsted St Chicago", mapLat:41.9401, mapLon:-87.6492, detailRestaurant:"Drew's on Halsted" },
      { time:"18:30", kind:"booked", icon:"🎃", title:"Haunted Halsted Halloween Parade", note:"Dalle 18:30 parte la fase di registrazione e atmosfera pre-parata; kickoff previsto alle 19:30. Spettatori gratis.", mapsQuery:"Halsted St and Belmont Ave Chicago", mapLat:41.9395, mapLon:-87.6491, detailPlace:"Haunted Halsted Halloween Parade" }
    ]},
    { date:"2026-11-01", title:"Architettura e centro", theme:"La crociera passa qui per non sovraccaricare Halloween", items:[
      { time:"10:00", kind:"recommended", icon:"🚶", title:"Partenza dal Warwick Allerton", note:"Mattina volutamente tranquilla dopo Halloween. Si scende verso Michigan Avenue e Wacker Drive.", mapsQuery:"Chicago Architecture Center River Cruise" },
      ...
      { time:"12:45", kind:"recommended", icon:"🌉", title:"Chicago Riverwalk", note:"Dopo lo sbarco restate sul fiume e completate con calma il tratto che vi è piaciuto di più.", mapsQuery:"Chicago Riverwalk", mapLat:41.8877, mapLon:-87.6263, detailPlace:"Chicago Riverwalk" },
      ...
      { time:"15:15", kind:"recommended", icon:"🎡", title:"Navy Pier", note:"Pomeriggio sul Lake Michigan, passeggiata sul molo e skyline. Nessuna attrazione a pagamento obbligatoria.", mapsQuery:"Navy Pier Chicago", mapLat:41.8917, mapLon:-87.6078, detailPlace:"Navy Pier" },
      { time:"17:30", kind:"recommended", icon:"🚶", title:"Rientro verso Magnificent Mile", note:"Passeggiata/rientro verso l'hotel; tempo libero per negozi o riposo." },
      { time:"19:30", kind:"recommended", icon:"🍝", title:"Quartino Ristorante", note:"Cena a River North, abbastanza vicina all'hotel: pasta, pizza e piccoli piatti da condividere.", mapsQuery:"Quartino Ristorante 626 N State St Chicago", mapLat:41.8935, mapLon:-87.6284, detailRestaurant:"Quartino Ristorante" }
    ]},
    { date:"2026-11-02", title:"Museo, panorama e deep dish", theme:"Ultima giornata piena, con parecchia libertà", items:[
      { time:"10:20", kind:"recommended", icon:"🚶", title:"Partenza dal Warwick Allerton", note:"Mattinata comoda: l'Art Institute il lunedì apre al pubblico alle 11:00, quindi non serve uscire presto.", mapsQuery:"Art Institute of Chicago" },
      { time:"11:00", kind:"recommended", icon:"🎨", title:"Art Institute of Chicago", note:"Ingresso all'apertura pubblica. Dedicate circa 2 ore e mezza alle opere principali senza trasformarlo in una maratona.", mapsQuery:"Art Institute of Chicago", mapLat:41.8796, mapLon:-87.6237, detailPlace:"Art Institute of Chicago" },
      { time:"13:45", kind:"recommended", icon:"🌳", title:"Grant Park & Buckingham Fountain", note:"Usciti dal museo proseguite verso sud nel parco fino alla fontana e al lakefront.", mapsQuery:"Buckingham Fountain Chicago", mapLat:41.8758, mapLon:-87.6189, detailPlace:"Grant Park & Buckingham Fountain" },
      { time:"14:45", kind:"recommended", icon:"🍿", title:"Garrett Popcorn / pausa", note:"Snack leggero mentre tornate verso Michigan Avenue; teniamoci spazio per la deep-dish serale." },
      { time:"16:00", kind:"recommended", icon:"🔭", title:"360 Chicago", note:"Vista dall'alto al 875 N Michigan. È praticamente accanto al vostro hotel, quindi è la scelta più efficiente rispetto allo Skydeck.", mapsQuery:"360 Chicago Observation Deck", mapLat:41.8988, mapLon:-87.6230, detailPlace:"360 Chicago" },
      { time:"17:30", kind:"recommended", icon:"🏨", title:"Rientro al Warwick Allerton", note:"Ultimo riposo in hotel prima della cena finale a Chicago." },
      { time:"19:30", kind:"recommended", icon:"🍕", title:"Giordano's · Millennium Park", note:"Ultima sera: stuffed deep-dish nel locale che avete già nella lista, senza aggiungere un'altra cucina da inseguire.", mapsQuery:"Giordano's 130 E Randolph St Chicago", mapLat:41.8845, mapLon:-87.6232, detailRestaurant:"Giordano's · Millennium Park" }
    ]},
...
const PLACE_DETAILS = {
  "Art Institute of Chicago": { image: "https://www.artic.edu/iiif/2/5a572c9c-68bf-9b10-2a09-4173d13f06c5/full/843,/0/default.jpg", text: "Uno dei grandi musei d'arte degli Stati Uniti, sulla Michigan Avenue accanto a Grant Park. Il lunedì l'apertura al pubblico è alle 11:00; nel vostro programma lo trattiamo come visita di circa due ore e mezza, concentrandovi sulle opere e sezioni che vi interessano davvero." },

  "Millennium Park": { image: "https://commons.wikimedia.org/wiki/Special:FilePath/Jay_Pritzker_Pavilion_in_Millennium_Park.jpg", text: "Millennium Park è il cuore contemporaneo del Loop, tra Michigan Avenue e il lago. Oltre a Cloud Gate ospita il Jay Pritzker Pavilion di Frank Gehry, Crown Fountain e Lurie Garden. Nel vostro itinerario del 31 ottobre è una passeggiata compatta: tutto è concentrato nella stessa area." },
  "Cloud Gate · The Bean": { image: "https://commons.wikimedia.org/wiki/Special:FilePath/The_Bean_-_Chicago.jpg", text: "Cloud Gate, soprannominata The Bean, è la grande scultura in acciaio lucidato di Anish Kapoor nel Millennium Park. La superficie riflette e deforma lo skyline di Chicago; si può camminare tutto intorno e sotto l'arco centrale." },
  "Navy Pier": { image: "https://commons.wikimedia.org/wiki/Special:FilePath/Navy_Pier_Chicago.JPG", text: "Navy Pier si protende nel Lake Michigan a Streeterville. È soprattutto una passeggiata sul lago con vista sullo skyline, ruota panoramica, locali e spazi interni: lo inseriamo nel pomeriggio del 1 novembre senza trasformarlo in una visita obbligatoriamente lunga." },
  "Grant Park & Buckingham Fountain": { image: "https://commons.wikimedia.org/wiki/Special:FilePath/Buckingham_Fountain_Chicago.jpg", text: "Grant Park è il grande spazio verde sul lakefront a sud di Millennium Park. Al centro si trova Buckingham Fountain, una delle fontane monumentali più note della città. A inizio novembre la fontana può non essere in funzione, ma resta un ottimo punto panoramico verso skyline e lago." },
  "360 Chicago": { image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/John_Hancock_Center_2.jpg/1280px-John_Hancock_Center_2.jpg", text: "360 Chicago occupa il 94° piano dell'ex John Hancock Center, al 875 N Michigan Avenue. Per voi è particolarmente comodo perché si trova a pochi minuti a piedi dal Warwick Allerton: lo teniamo come vista dall'alto nel pomeriggio del 2 novembre." },
