  ...
  legs: [
    {
      ...
      foods: [
        { id: "sf-clam", name: "Clam Chowder nel pane", short: "Zuppa cremosa di vongole servita nella pagnotta di sourdough.", description: "Una delle specialità più associate al waterfront di San Francisco: clam chowder cremosa con patate e vongole, spesso servita dentro una pagnotta di pane sourdough.", whereToFind: [{ name: "Boudin Bakery · Fisherman's Wharf", image: "https://d34vm3j4h7f97z.cloudfront.net/original/4X/5/f/5/5f5bebe77e8b1290035a020692660b81c63e2336.jpeg", note: "Iconico per clam chowder servita nel sourdough bread bowl.", price: "$$", mapsQuery: "Boudin Bakery 160 Jefferson St San Francisco" }, { name: "Scoma's Restaurant", image: "https://images.berqwp.com/?domain=scomas.com&mw=1920&q=70&url=https%3A%2F%2Fscomas.com%2Fwp-content%2Fuploads%2F2026%2F02%2FScomas-credit-Rich-Johnson-e1781155482447.png&w=300", note: "Versione più da ristorante, sul Fisherman's Wharf.", price: "$$$", mapsQuery: "Scoma's Restaurant San Francisco" }], image: "./assets/food/sf-clam-chowder.jpg", photoCredit: "Prayitno / Wikimedia Commons · CC BY 2.0" },
        { id: "sf-burrito", name: "Mission Burrito", short: "Burrito grande e ricco nato nel Mission District.", description: "Burrito in stile Mission: tortilla di farina molto farcita con riso, fagioli, carne e condimenti. È uno dei cibi simbolo della cultura gastronomica di San Francisco.", whereToFind: [{ name: "La Taqueria", image: "https://s.hdnux.com/photos/44/42/65/9579876/10/rawImage.jpg", note: "Una delle taquerias simbolo del Mission District.", price: "$", mapsQuery: "La Taqueria 2889 Mission St San Francisco" }], image: "./assets/food/sf-mission-burrito.jpg", photoCredit: "Ryan Michael / Wikimedia Commons · CC BY-SA 2.0" }
      ],
      restaurants: [
...

    {
      ...
      foods: [
        { id: "la-tacos", name: "Tacos al pastor", short: "Street food messicano, parte essenziale della scena gastronomica di LA.", description: "Tortillas con carne al pastor arrostita sul trompo, cipolla, coriandolo, salsa e spesso ananas. A Los Angeles i taco truck e le taquerias sono una parte fondamentale della cucina cittadina.", whereToFind: [{ name: "Guelaguetza", image: "https://nhm.org/sites/default/files/styles/asp_switcher_4_3_med/public/2024-07/guel2.jpg", note: "Per una tappa messicana più strutturata e molto legata alla cultura gastronomica di LA.", price: "$$", mapsQuery: "Guelaguetza Los Angeles" }], image: "./assets/food/la-tacos-al-pastor.jpg", photoCredit: "T.Tseng / Wikimedia Commons · CC BY 2.0" },
      ...
      restaurants: [
        ...
        { name: "Musso & Frank Grill", image: "https://www.islands.com/img/gallery/hollywoods-oldest-restaurant-is-a-timeless-tasty-gem-that-frequently-attracts-celebrities/l-intro-1728503362.jpg", meal: "serious", price: "$$$$", type: "Old Hollywood · steakhouse", typeIcon: "🥩", note: "Istituzione di Hollywood dal fascino storico: da scegliere se volete una vera cena Old Hollywood.", mapsQuery: "Musso & Frank Grill 6667 Hollywood Blvd Los Angeles" },
...

    {
      ...
      activities: [], restaurants: [
        { name: "Tacos El Gordo", image: "https://worldtraveller73.com/wp-content/uploads/2024/10/img_2788.jpeg?w=1024", meal: "quick", price: "$", type: "Tacos · street food", typeIcon: "🌮", note: "Uno dei nomi più popolari della Strip per tacos in stile Tijuana: veloce, informale e relativamente economico.", mapsQuery: "Tacos El Gordo 3041 S Las Vegas Blvd" },
        ...
        { name: "Eiffel Tower Restaurant", image: "https://cdn0.weddingwire.com/vendor/108901/3_2/960/jpg/1449177805074-et-lounge.webp", meal: "serious", price: "$$$$", type: "Francese · vista", typeIcon: "🍷", note: "Nel Paris Las Vegas: cena panoramica e romantica, da considerare solo se volete concedervi una serata costosa.", mapsQuery: "Eiffel Tower Restaurant Paris Las Vegas" }
      ], days: [], tickets: []
    },

    {
      ...
      restaurants: [
        ...
        { name: "Big John's Texas BBQ", image: "https://www.mondovagandosenzameta.it/wp-content/uploads/2024/04/Big-Johns-Texas-BBQ-Page-Arizona-1.jpg", meal: "quick", price: "$$", type: "Barbecue", typeIcon: "🥩", note: "BBQ informale con brisket, ribs e porzioni abbondanti. Uno dei nomi più citati a Page.", mapsQuery: "Big John's Texas BBQ Page Arizona" },
...

    {
      ...
      activities: [
        ...
        { name: "Giordano's · Millennium Park", image: "https://giordanos.com/locations/custom/30344.jpg", meal: "quick", price: "$$", type: "Stuffed deep-dish", typeIcon: "🍕", note: "Altra istituzione cittadina, utile se volete confrontare lo stile stuffed con la deep-dish classica.", mapsQuery: "Giordano's 130 E Randolph St Chicago" },
