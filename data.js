  ...
  legs: [
    {
      ...
      foods: [
        { id: "sf-clam", name: "Clam Chowder nel pane", short: "Zuppa cremosa di vongole servita nella pagnotta di sourdough.", description: "Una delle specialità più associate al waterfront di San Francisco: clam chowder cremosa con patate e vongole, spesso servita dentro una pagnotta di pane sourdough.", whereToFind: [{ name: "Boudin Bakery · Fisherman's Wharf", image: "https://res.cloudinary.com/the-infatuation/image/upload/c_fill%2Cw_3840%2Car_4%3A3%2Cg_center%2Cf_auto/Drone_ydve3c", note: "Iconico per clam chowder servita nel sourdough bread bowl.", price: "$$", mapsQuery: "Boudin Bakery 160 Jefferson St San Francisco" }, { name: "Scoma's Restaurant", image: "https://images.berqwp.com/?domain=scomas.com&mw=1920&q=70&url=https%3A%2F%2Fscomas.com%2Fwp-content%2Fuploads%2F2026%2F02%2FScomas-credit-Rich-Johnson-e1781155482447.png&w=300", note: "Versione più da ristorante, sul Fisherman's Wharf.", price: "$$$", mapsQuery: "Scoma's Restaurant San Francisco" }], image: "./assets/food/sf-clam-chowder.jpg", photoCredit: "Prayitno / Wikimedia Commons · CC BY 2.0" },
      ...
      restaurants: [
        { name: "Uncle Vito's Pizzeria", image: "./assets/food/la-french-dip.jpg", meal: "quick", price: "$$", type: "Pizza · italiano", typeIcon: "🍕", note: "Scelta semplice per la prima sera: pizza e cucina italiana in zona Union Square, comoda da Hotel Spero.", mapsQuery: "Uncle Vito's Pizzeria San Francisco" },
        { name: "Wipeout Bar & Grill", image: "./assets/food/la-french-dip.jpg", meal: "quick", price: "$$", type: "Americano · burger · tacos", typeIcon: "🍔", note: "Al Pier 39, comodo dopo il rientro da Alcatraz per una cena informale senza deviazioni.", mapsQuery: "Wipeout Bar & Grill Pier 39 San Francisco" },
        ...
        { name: "The Cheesecake Factory", image: "./assets/food/la-french-dip.jpg", meal: "quick", price: "$$", lf: true, type: "Dolci · cucina americana", typeIcon: "🍰", note: "Segnato da Fortuna · Union Square, all'ultimo piano di Macy's. Buono anche per cheesecake + vista.", mapsQuery: "The Cheesecake Factory 251 Geary St San Francisco" },
        ...
        { name: "Fog Harbor Fish House", image: "./assets/food/sf-clam-chowder.jpg", meal: "serious", price: "$$$", lf: true, type: "Pesce", typeIcon: "🐟", note: "Segnato da Fortuna · Pier 39, pesce e vista sulla baia.", mapsQuery: "Fog Harbor Fish House Pier 39 San Francisco" },
...

    {
      ...
      restaurants: [
        ...
        { name: "Water Grill Santa Monica", image: "./assets/food/sf-clam-chowder.jpg", meal: "serious", price: "$$$", lf: true, type: "Pesce", typeIcon: "🐟", note: "Segnato da Fortuna · Ocean Avenue, vicino al Santa Monica Pier. Cena di pesce più completa.", mapsQuery: "Water Grill Santa Monica 1401 Ocean Ave" },
        { name: "The Little Door", image: "./assets/food/vegas-prime-rib.jpg", meal: "serious", price: "$$$$", lf: true, type: "Mediterraneo · cena", typeIcon: "🍷", note: "Segnato da Fortuna · atmosfera romantica, più adatto a una cena con calma.", mapsQuery: "The Little Door 8164 W 3rd St Los Angeles" },
        { name: "Musso & Frank Grill", image: "./assets/food/vegas-prime-rib.jpg", meal: "serious", price: "$$$$", type: "Old Hollywood · steakhouse", typeIcon: "🥩", note: "Istituzione di Hollywood dal fascino storico: da scegliere se volete una vera cena Old Hollywood.", mapsQuery: "Musso & Frank Grill 6667 Hollywood Blvd Los Angeles" },
        { name: "République", image: "./assets/food/la-french-dip.jpg", meal: "serious", price: "$$$", lf: true, type: "Francese · bakery · brunch", typeIcon: "🥐", note: "Segnato da Fortuna · storico edificio su La Brea, molto apprezzato per bakery, brunch e cucina francese contemporanea.", mapsQuery: "Republique 624 S La Brea Ave Los Angeles CA 90036" }
      ], days: [], tickets: []
    },

    {
      ...
      foods: [
        ...
        { id: "vegas-primerib", name: "Prime Rib", short: "Arrosto di manzo spesso associato alle steakhouse e ai casinò classici.", description: "Taglio di manzo arrostito lentamente, servito spesso al sangue o media cottura. È uno dei piatti più rappresentativi della tradizione da steakhouse di Las Vegas.", whereToFind: [{ name: "Golden Steer Steakhouse", image: "https://goldensteer.com/cdn/shop/files/history.jpg?v=1699049745&width=638", note: "Steakhouse old-school: scelta perfetta per vivere il lato classico della prime rib e della carne a Las Vegas.", price: "$$$$", mapsQuery: "Golden Steer Steakhouse Las Vegas" }], image: "./assets/food/vegas-prime-rib.jpg", photoCredit: "Steven Miller / Wikimedia Commons · CC BY 2.0" }
      ],
      activities: [], restaurants: [
        ...
        { name: "Hash House A Go Go · LINQ", image: "./assets/food/vegas-prime-rib.jpg", meal: "quick", price: "$$", type: "Americano · porzioni enormi", typeIcon: "🍳", note: "Piatti americani esagerati e porzioni gigantesche: più esperienza Vegas che cena elegante.", mapsQuery: "Hash House A Go Go LINQ Las Vegas" },
...

    {
      ...
      restaurants: [
        { name: "BirdHouse", image: "https://images.squarespace-cdn.com/content/v1/5d96d76e3283e84e5fd27a23/1581651479592-OQRKMAK98618KIN2U6VI/IMG_20191014_115108.jpg", meal: "quick", price: "$", type: "Fried chicken", typeIcon: "🍗", note: "Molto apprezzato a Page, semplice e veloce: ideale dopo una giornata tra canyon e strada.", mapsQuery: "BirdHouse 707 N Navajo Dr Page AZ" },
        { name: "Big John's Texas BBQ", image: "https://www.bons-plans-voyage-ouest-americain.com/wordpress/wp-content/uploads/2019/02/big-johns-texas-BBQ-restaurant-ambiance-americaine-1--800x500.jpg", meal: "quick", price: "$$", type: "Barbecue", typeIcon: "🥩", note: "BBQ informale con brisket, ribs e porzioni abbondanti. Uno dei nomi più citati a Page.", mapsQuery: "Big John's Texas BBQ Page Arizona" },
        { name: "El Tapatio", image: "./assets/food/la-tacos-al-pastor.jpg", meal: "quick", price: "$$", type: "Messicano", typeIcon: "🌮", note: "Messicano molto frequentato: carne asada e piatti sostanziosi, comodo senza perdere troppo tempo.", mapsQuery: "El Tapatio Page Arizona" },
        { name: "Sunset 89", image: "./assets/food/page-frybread.jpg", meal: "serious", price: "$$", type: "Americano · island fusion", typeIcon: "🍽️", note: "Una scelta più tranquilla per sedersi a cena a Page, con menu più ampio rispetto ai fast casual.", mapsQuery: "Sunset 89 Page Arizona" }
      ], days: [], tickets: []
    },
...

    {
      ...
      activities: [
        ...
        { name: "Giordano's · Millennium Park", image: "./assets/food/chicago-italian-beef.jpg", meal: "quick", price: "$$", type: "Stuffed deep-dish", typeIcon: "🍕", note: "Altra istituzione cittadina, utile se volete confrontare lo stile stuffed con la deep-dish classica.", mapsQuery: "Giordano's 130 E Randolph St Chicago" },
        ...
        { name: "Girl & The Goat", image: "./assets/food/vegas-prime-rib.jpg", meal: "serious", price: "$$$", type: "Americano moderno", typeIcon: "🍽️", note: "Uno dei ristoranti più noti di West Loop: cena da prenotare se volete dedicare una serata al cibo.", mapsQuery: "Girl & The Goat 809 W Randolph St Chicago" }
      ], days: [], tickets: []
    },
