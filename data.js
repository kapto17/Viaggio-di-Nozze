...
{ time:"Apertura", kind:"booked", icon:"🎬", title:"Universal Studios Hollywood", note:"Arrivate poco prima dell'apertura e dedicate il giorno al parco.", mapsQuery:"Universal Studios Hollywood" },
  ...
  chicago: [
    ...
    { date:"2026-10-31", title:"Halloween a Chicago 🎃", theme:"Turismo leggero di giorno, Haunted Halsted come evento principale", special:true, items:[
      { time:"09:20", kind:"recommended", icon:"🚶", title:"Partenza dal Warwick Allerton", note:"Prima giornata piena a Chicago: si parte a piedi, senza sveglia aggressiva.", transportTip:"🚶 A piedi · 2–5 min", mapsQuery:"Magnificent Mile Chicago" },
      { time:"09:30", kind:"recommended", icon:"🏙️", title:"Magnificent Mile", note:"Passeggiata lungo Michigan Avenue partendo praticamente dalla porta dell'hotel.", transportTip:"🚶 A piedi · ~12 min verso il Riverwalk", mapsQuery:"Magnificent Mile Chicago", mapLat:41.8954, mapLon:-87.6243, detailPlace:"Magnificent Mile" },
      { time:"10:45", kind:"recommended", icon:"🌉", title:"Chicago Riverwalk", note:"Scendete verso il fiume e passeggiate tra ponti e grattacieli senza fretta.", transportTip:"🚶 A piedi · ~15 min verso Portillo's", mapsQuery:"Chicago Riverwalk", mapLat:41.8877, mapLon:-87.6263, detailPlace:"Chicago Riverwalk" },
      { time:"12:30", kind:"recommended", icon:"🌭", title:"Portillo's · River North", note:"Pranzo rapido con Chicago-style hot dog o Italian beef.", transportTip:"🚇 CTA consigliata · ~15 min", mapsQuery:"Portillo's 100 W Ontario St Chicago", mapLat:41.8930, mapLon:-87.6312, detailRestaurant:"Portillo's · River North" },
      { time:"14:00", kind:"recommended", icon:"🌳", title:"Millennium Park", note:"Pritzker Pavilion, Crown Fountain e una passeggiata nel parco.", transportTip:"🚶 A piedi · 2 min", mapsQuery:"Millennium Park Chicago", mapLat:41.8826, mapLon:-87.6226, detailPlace:"Millennium Park" },
      { time:"14:40", kind:"recommended", icon:"☁️", title:"Cloud Gate · The Bean", note:"Tappa dedicata al simbolo del parco e alle classiche foto con lo skyline riflesso.", transportTip:"🚇 CTA · ~15 min per rientrare in hotel", mapsQuery:"Cloud Gate Chicago", mapLat:41.8827, mapLon:-87.6233, detailPlace:"Cloud Gate · The Bean" },
    ...
    { date:"2026-11-02", title:"Museo, panorama e deep dish", theme:"Ultima giornata piena, con parecchia libertà", items:[
      { time:"10:20", kind:"recommended", icon:"🚶", title:"Partenza dal Warwick Allerton", note:"Mattinata comoda: l'Art Institute il lunedì apre al pubblico alle 11:00, quindi non serve uscire presto.", transportTip:"🚇 CTA/bus consigliata · ~15–20 min", mapsQuery:"Art Institute of Chicago" },
